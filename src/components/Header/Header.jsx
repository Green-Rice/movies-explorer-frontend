            ...
            <div className="burger">
              ...
              <div
                className={`burger__container ${
                  isBurgerOpen && 'burger__container_opened'
                }`}
              >
                <button
                  type="button"
                  className="button burger__button burger__button_type_close"
                  onClick={toggleBtnMenu}
                >
                ...
                <div className="burger__flex-column">
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `${
                        isActive
                          ? 'link burger__link burger__link_active'
                          : 'link burger__link'
                      }`
                    }
                    onClick={toggleBtnMenu}
      ...
      <header className={`header ${isMainPage && 'header__main'}`}>
        <div className="header__container content">
          ...
          <div className="header__nav">
            ...
            <Link
              to="/signin"
              className="link header__link header__link_type_btn"
            >
              Войти
            </Link>
          </div>
